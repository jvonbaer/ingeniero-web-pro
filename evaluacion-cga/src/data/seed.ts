...
import { indicadoresActivos, nuevoId } from "../domain/scoring";
...
function armarEvaluacion(
  ...
  for (const categoria of RUBRICA_BASE.categorias) {
  ...
  return {
    ...
    entrenador,
    rubricaVersion: RUBRICA_BASE.version,
    escalaMax: RUBRICA_BASE.escalaMax,
    puntajes,
    observaciones,
    objetivos: proximos,
    estado: "finalizada",
...
export function datosDemo(): Backup {
  ...
  const evaluaciones: Evaluacion[] = [
    armarEvaluacion(
      matias.id, "2023-11-20", "Cristián Gómez",
    ...
    armarEvaluacion(
      matias.id, "2024-02-20", "Cristián Gómez",
    ...
    armarEvaluacion(
      matias.id, "2024-05-20", "Cristián Gómez",
    ...
    armarEvaluacion(
      emilia.id, "2024-02-20", "Cristián Gómez",
    ...
    armarEvaluacion(
      emilia.id, "2024-05-20", "Cristián Gómez",
    ...
    armarEvaluacion(
      benja.id, "2024-05-20", "Cristián Gómez",
    ...
    armarEvaluacion(
      tomas.id, "2024-05-20", "Paula Riquelme",
